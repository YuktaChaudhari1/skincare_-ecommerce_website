        ...
        <div className="min-h-screen bg-surface flex items-center justify-center pt-24 pb-12 px-8">
            <div className="bg-white p-10 shadow-2xl w-full max-w-md border border-blush">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-serif text-dark mb-2">Join Aurielle</h1>
                    <p className="text-gray-500 text-sm">Create an account for the ultimate luxury experience</p>
                </div>
                ...
                <form onSubmit={handleSignup} className="space-y-6">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2 uppercase tracking-widest text-xs">Full Name</label>
                        <input name="name" type="text" required onChange={handleChange} className="w-full p-4 border border-gray-200 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold bg-surface transition-colors" />
                    </div>
                    <div>
                    ...
                    <div className="text-center mt-6">
                        <Link to="/login" className="text-sm text-gray-500 hover:text-gold transition-colors">Already have an account? <span className="uppercase tracking-widest text-xs border-b border-gray-300">Sign In</span></Link>
                    </div>
                </form>
